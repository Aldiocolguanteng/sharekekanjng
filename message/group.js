...
module.exports = welcome = async (nino, anu) => {
		...
		try {
            ...
            nino.sendMessage(anu.jid, 'Halo! Terima Kasih sudah Mengundangku, Jika ingin Menggunakan Bot, Tolong Jadikan Admin Ya, Ketik !menu', 'conversation')
             ...
             if (!welkom.includes(anu.jid)) return
              ...
              buff = await getBuffer(pic)
               nino.sendMessage(mdata.id, { contentText: `${teks}`, footerText: `*✗⃝☯️AkiraBotz*`, buttons: [{buttonId: `!menu`,buttonText:{displayText: '✗⃝📘MENU'},type:1},{buttonId: `!rules`,buttonText:{displayText:'✗⃝⚙️RULES'},type:1},{buttonId:`!infogrup`,buttonText:{displayText:'✗⃝💌INFOGC'},type:1}],headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: buff, contextInfo: {"mentionedJid": [num]}}}, 'buttonsMessage')
		}
            ...
            if (!welkom.includes(anu.jid)) return
               ...
               buff = await getBuffer(pic)
               nino.sendMessage(mdata.id, { contentText: `${out}`, footerText: `*✗⃝☯️AkiraBotz*`, buttons: [{buttonId: `!byebeban`,buttonText:{displayText: '✗⃝👋🏻BYE'},type:1},{buttonId: `!donasi`,buttonText:{displayText: '✗⃝💵DONASI'},type:1}],headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: buff, contextInfo: {"mentionedJid": [num]}}}, 'buttonsMessage')
            }
		} catch (e) {
