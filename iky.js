...
case 'sendbug':
        ...
        case 'creator':
               ...
               buttons = [{buttonId: '!sourcecode',buttonText:{displayText: '✗⃝📄SCRIPT'},type:1},{buttonId:'!infoig',buttonText:{displayText:'✗⃝💌INSTAGRAM'},type:1},{buttonId:'!sewabot',buttonText:{displayText:'✗⃝💸SEWA'},type:1}]
...
`
                    ...
                    ikyy.sendMessage(from, { contentText: `${menu}`, footerText: '*_✗✗✗_ ᗩᴋɪʀᴀᗷoтz々*', buttons: [{ buttonId: `!command`, buttonText: { displayText: 'LIST' }, type: 1 },{ buttonId: `!akira`, buttonText: { displayText: 'CATALOG' }, type: 1 }], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: ikyads, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
              break
case 'f':
case 'lock':
 ikymemek = {
