...
*「 AkiraBotz 」*`
         ikyads = await getBuffer(`http://hadi-api.herokuapp.com/api/card/verify?nama=${encodeURI(pushname)}&member=${_registered.length}&seri=${serialUser}&pp=${ppimg}&bg=${ppimg}`)
             buttons = [{buttonId: `!menu`,buttonText:{displayText: `✗⃝📘MENU`},type:1},{buttonId: `!rules`,buttonText:{displayText: `✗⃝⚙️RULES`},type:1}]
...
//------------------< Premium >-------------------
       ...
       case 'ruleskirbotz':
       case 'rulesbotz':
              fokirbot = 'https://telegra.ph/file/166271e47317ecbe47b28.jpg'
            buff = await getBuffer(fokirbot)
            teksnya = `
*❒─────⎔✗⃝🌹 「 RULES BOT 」⎔──❒*
*➪1.* Jangan Spam Bot. 
...
_*➪*_ _Jika sudah dipahami rules-nya, silakan ketik *!menu* untuk memulai!_
*❒───⎔✗⃝🌹*
...
*❒───⎔✗⃝💌*
`
  buttons = [{buttonId: `${prefix}menu`,buttonText:{displayText: `✗⃝📘MENU`},type:1},{buttonId: `${prefix}owner`,buttonText:{displayText: `✗⃝👤OWNER`},type:1},{buttonId: `${prefix}sewabot`,buttonText:{displayText: `✗⃝💵SEWA`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'_Jika Sudah Paham Rules_\n_Pencet *MENU* Di Bawah_', imageMessage: imageMsg,
...
*❒───⎔✗⃝💌*
`
  buttons = [{buttonId: `${prefix}owner`,buttonText:{displayText: `✗⃝👤OWNER`},type:1},{buttonId: `${prefix}payment`,buttonText:{displayText: `✗⃝🕊PAYMENT`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'*Jika Minat Pencet Owner Di Bawah*', imageMessage: imageMsg,
              contentText: teksnya,buttons,headerType:4}
              prep = await ikyy.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
              ikyy.relayWAMessage(prep)
      break
...
`
              ...
              break
       case 'viapulsa':  // Jangan Di Ubah Plise
               urlinfo = 'https://telegra.ph/file/166271e47317ecbe47b28.jpg'
               thankslort = `
*MAU DONASI BWANG?*
NIH : 0877-0504-8235
ISIIN PULSA YAH BWANG
`
             ikyy.sendMessage(from, await getBuffer(urlinfo), image, {quoted: freply, caption: thankslort })
             break
       case 'viaovo':  // Jangan Di Ubah Plise
               urlinfo = 'https://telegra.ph/file/166271e47317ecbe47b28.jpg'
               thankslort = `
*MAU DONASI BWANG?*
NIH : 0877-0504-8235
ISIIN SALDO OVO YAH BWANG
`
             ikyy.sendMessage(from, await getBuffer(urlinfo), image, {quoted: freply, caption: thankslort })
             break
       case 'viadana':  // Jangan Di Ubah Plise
               urlinfo = 'https://telegra.ph/file/166271e47317ecbe47b28.jpg'
               thankslort = `
*MAU DONASI BWANG?*
NIH : 0877-0504-8235
ISIIN SALDO DANA YAH BWANG
`
             ikyy.sendMessage(from, await getBuffer(urlinfo), image, {quoted: freply, caption: thankslort })
             break
       case 'sourcecode': 
...
//------------------< SOUND >-------------------
        case 'sound1':
              if (!isRegistered) return reply(ind.only.daftarB)
               ...
               ikyy.sendMessage(from, sound1, audio, { mimetype: 'audio/mp4', duration: 999999999, ptt: true, quoted: mek})
               break 
        case 'sound2':
              if (!isRegistered) return reply(ind.only.daftarB)
               const sound2 = fs.readFileSync('./mp3/sound2.mp3')
               ikyy.sendMessage(from, sound2, audio, { mimetype: 'audio/mp4', duration: 999999999, ptt: true, quoted: mek})
               break                          
        case 'sound3':
              if (!isRegistered) return reply(ind.only.daftarB)
               const sound3 = fs.readFileSync('./mp3/sound3.mp3')
               ikyy.sendMessage(from, sound3, audio, { mimetype: 'audio/mp4', duration: 999999999, ptt: true, quoted: mek})
               break 
        case 'sound4':
              if (!isRegistered) return reply(ind.only.daftarB)
               const sound4 = fs.readFileSync('./mp3/sound4.mp3')
               ikyy.sendMessage(from, sound4, audio, { mimetype: 'audio/mp4', duration: 999999999, ptt: true, quoted: mek})
               break 
        case 'sound5':
              if (!isRegistered) return reply(ind.only.daftarB)
               const sound5 = fs.readFileSync('./mp3/sound5.mp3')
               ikyy.sendMessage(from, sound5, audio, { mimetype: 'audio/mp4', duration: 999999999, ptt: true, quoted: mek})
               break      
        case 'sound6':
              if (!isRegistered) return reply(ind.only.daftarB)
               const sound6 = fs.readFileSync('./mp3/sound6.mp3')
               ikyy.sendMessage(from, sound6, audio, { mimetype: 'audio/mp4', duration: 999999999, ptt: true, quoted: mek})
               break           
        case 'sound7':
              if (!isRegistered) return reply(ind.only.daftarB)
               const sound7 = fs.readFileSync('./mp3/sound7.mp3')
               ikyy.sendMessage(from, sound7, audio, { mimetype: 'audio/mp4', duration: 999999999, ptt: true, quoted: mek})
               break                
        case 'sound8':
              if (!isRegistered) return reply(ind.only.daftarB)
               const sound8 = fs.readFileSync('./mp3/sound8.mp3')
               ikyy.sendMessage(from, sound8, audio, { mimetype: 'audio/mp4', duration: 999999999, ptt: true, quoted: mek})
               break                
        case 'sound9':
              if (!isRegistered) return reply(ind.only.daftarB)
               const sound9 = fs.readFileSync('./mp3/sound9.mp3')
               ikyy.sendMessage(from, sound9, audio, { mimetype: 'audio/mp4', duration: 999999999, ptt: true, quoted: mek})
               break                
        case 'sound10':
              if (!isRegistered) return reply(ind.only.daftarB)
               const sound10 = fs.readFileSync('./mp3/sound10.mp3')
               ikyy.sendMessage(from, sound10, audio, { mimetype: 'audio/mp4', duration: 999999999, ptt: true, quoted: mek})
               break                
        case 'sound11':
              if (!isRegistered) return reply(ind.only.daftarB)
               const sound11 = fs.readFileSync('./mp3/sound11.mp3')
               ikyy.sendMessage(from, sound11, audio, { mimetype: 'audio/mp4', duration: 999999999, ptt: true, quoted: mek})
               break                
        case 'sound12':
              if (!isRegistered) return reply(ind.only.daftarB)
               const sound12 = fs.readFileSync('./mp3/sound12.mp3')
               ikyy.sendMessage(from, sound12, audio, { mimetype: 'audio/mp4', duration: 999999999, ptt: true, quoted: mek})
               break                
        case 'sound13':
              if (!isRegistered) return reply(ind.only.daftarB)
               const sound13 = fs.readFileSync('./mp3/sound13.mp3')
               ikyy.sendMessage(from, sound13, audio, { mimetype: 'audio/mp4', duration: 999999999, ptt: true, quoted: mek})
               break                
        case 'sound14':
              if (!isRegistered) return reply(ind.only.daftarB)
               const sound14 = fs.readFileSync('./mp3/sound14.mp3')
               ikyy.sendMessage(from, sound14, audio, { mimetype: 'audio/mp4', duration: 999999999, ptt: true, quoted: mek})
               break                
        case 'sound15':
              if (!isRegistered) return reply(ind.only.daftarB)
               const sound15 = fs.readFileSync('./mp3/sound15.mp3')
               ikyy.sendMessage(from, sound15, audio, { mimetype: 'audio/mp4', duration: 999999999, ptt: true, quoted: mek})
               break                
        case 'sound16':
              if (!isRegistered) return reply(ind.only.daftarB)
               const sound16 = fs.readFileSync('./mp3/sound16.mp3')
               ikyy.sendMessage(from, sound16, audio, { mimetype: 'audio/mp4', duration: 999999999, ptt: true, quoted: mek})
               break                
        case 'sound17':
              if (!isRegistered) return reply(ind.only.daftarB)
               const sound17 = fs.readFileSync('./mp3/sound17.mp3')
               ikyy.sendMessage(from, sound17, audio, { mimetype: 'audio/mp4', duration: 999999999, ptt: true, quoted: mek})
               break                
        case 'sound18':
              if (!isRegistered) return reply(ind.only.daftarB)
               const sound18 = fs.readFileSync('./mp3/sound18.mp3')
               ikyy.sendMessage(from, sound18, audio, { mimetype: 'audio/mp4', duration: 999999999, ptt: true, quoted: mek})
               break                
        case 'sound19':
              if (!isRegistered) return reply(ind.only.daftarB)
               const sound19 = fs.readFileSync('./mp3/sound19.mp3')
               ikyy.sendMessage(from, sound19, audio, { mimetype: 'audio/mp4', duration: 999999999, ptt: true, quoted: mek})
               break                
        case 'sound20':
              if (!isRegistered) return reply(ind.only.daftarB)
               const sound20 = fs.readFileSync('./mp3/sound20.mp3')
               ikyy.sendMessage(from, sound20, audio, { mimetype: 'audio/mp4', duration: 999999999, ptt: true, quoted: mek})
               break                
        case 'sound21':
              if (!isRegistered) return reply(ind.only.daftarB)
               const sound21 = fs.readFileSync('./mp3/sound21.mp3')
               ikyy.sendMessage(from, sound21, audio, { mimetype: 'audio/mp4', duration: 999999999, ptt: true, quoted: mek})
               break                
        case 'sound22':
              if (!isRegistered) return reply(ind.only.daftarB)
               const sound22 = fs.readFileSync('./mp3/sound22.mp3')
               ikyy.sendMessage(from, sound22, audio, { mimetype: 'audio/mp4', duration: 999999999, ptt: true, quoted: mek})
               break                
        case 'sound23':
              if (!isRegistered) return reply(ind.only.daftarB)
               const sound23 = fs.readFileSync('./mp3/sound23.mp3')
               ikyy.sendMessage(from, sound23, audio, { mimetype: 'audio/mp4', duration: 999999999, ptt: true, quoted: mek})
               break                
        case 'sound24':
              if (!isRegistered) return reply(ind.only.daftarB)
               const sound24 = fs.readFileSync('./mp3/sound24.mp3')
               ikyy.sendMessage(from, sound24, audio, { mimetype: 'audio/mp4', duration: 999999999, ptt: true, quoted: mek})
               break              
        case 'sound25':
              if (!isRegistered) return reply(ind.only.daftarB)
               const sound25 = fs.readFileSync('./mp3/sound25.mp3')
               ikyy.sendMessage(from, sound25, audio, { mimetype: 'audio/mp4', duration: 999999999, ptt: true, quoted: mek})
               break                                                        
        case 'sound26':
              if (!isRegistered) return reply(ind.only.daftarB)
               const sound26 = fs.readFileSync('./mp3/sound26.mp3')
               ikyy.sendMessage(from, sound26, audio, { mimetype: 'audio/mp4', duration: 999999999, ptt: true, quoted: mek})
               break
        case 'sound27':
              if (!isRegistered) return reply(ind.only.daftarB)
               const sound27 = fs.readFileSync('./mp3/sound27.mp3')
               ikyy.sendMessage(from, sound27, audio, { mimetype: 'audio/mp4', duration: 999999999, ptt: true, quoted: mek})
               break
//------------------< G R U P >-------------------
      case 'kick':
